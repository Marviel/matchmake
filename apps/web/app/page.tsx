...
export default function Page() {
  ...
  const [profileContent, setProfileContent] = useState({
    them: {
      name: "Theodore",
      avatar: "/theodore.png",
      body: trimLines(`I'm looking for a life partner who shares my worldview and values. I'm in my late 20s, living in a major city, and working in the tech industry. I'm open to dating people from other locations but prefer to settle in a global hub long-term. I'm undecided about having children but open to discussion with the right person.
